    ...
    if (searchInput && searchButton) {
        ...
        const handleSearch = () => {
            ...
            if (query) {
                ...
                window.location.href = `../search/Search.en-US.webpage.copy.html?q=${encodeURIComponent(query)}`;
            }
        };
...
function showSearchSuggestions(query) {
    ...
    const suggestions = [
        { term: 'framework', url: '../framework-overview/FrameworkOverview.en-US.webpage.copy.html', title: 'Framework Overview' },
        { term: 'assessment', url: '../assessment-tools/AssessmentTools.en-US.webpage.copy.html', title: 'Assessment Tools' },
        { term: 'step 1', url: '../step-1-use-case-assessment/Step1UseCaseAssessment.en-US.webpage.copy.html', title: 'Step 1: Use Case Assessment' },
        { term: 'step 2', url: '../step-2-assess-source-data/Step2AssessSourceData.en-US.webpage.copy.html', title: 'Step 2: Assess Source Data' },
        { term: 'step 3', url: '../step-3-generate-synthetic-data/Step3GenerateSyntheticData.en-US.webpage.copy.html', title: 'Step 3: Generate Synthetic Data' },
        { term: 'step 4', url: '../step-4-assess-reidentification-risks/Step4AssessReidentificationRisks.en-US.webpage.copy.html', title: 'Step 4: Assess Reidentification Risks' },
        { term: 'step 5', url: '../step-5-manage-residual-risks/Step5ManageResidualRisks.en-US.webpage.copy.html', title: 'Step 5: Manage Residual Risks' },
        { term: 'resources', url: '../resources/Resources.en-US.webpage.copy.html', title: 'Resources' },
        { term: 'about', url: '../about/About.en-US.webpage.copy.html', title: 'About' },
        { term: 'contact', url: '../about/contact/Contact.en-US.webpage.copy.html', title: 'Contact Us' }
    ];
...
function suggestSimilarPages() {
    ...
    if (currentPath.includes('assessment')) {
        suggestions.push({
            ...
            url: '../assessment-tools/AssessmentTools.en-US.webpage.copy.html',
